// data/questions/preferences_31_40.js
(function () { "use strict";
  ...
  window.QUESTIONS.push(
    {
      ...
      options: [
        ...
        { text: "寒意初起的早春", scores: { persephone: 3, hecate: 1 } },
    ...
    },
    {
      ...
      question: "最吸引你的颜色是？",
      options: [
        { text: "灼目的纯金色", scores: { apollo: 3, zeus: 1 } },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "礁石环抱的海岛", scores: { odysseus: 3, poseidon: 1 } }
      ]
    },
    {
      id: 38,
      ...
      options: [
        ...
        { text: "被回应的爱", scores: { aphrodite: 3, orpheus: 1 } },
    ...
    },
    {
      ...
      question: "哪种美最让你心动？",
      options: [
        { text: "无瑕的完美比例", scores: { apollo: 3, aphrodite: 1 } },
